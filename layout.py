	...
	if dir in ["human", "mouse"]:
		...
		if "species" in dir:
			...
			if "mds" in metatranscriptomics_content:
				...
				expression_datasets_options.append({"label": kingdom.capitalize(), "value": dir})
...
layout = html.Div([			
	html.Div([
		...
		html.Div([
			...
			#mds switches and info
			html.Div([
				html.Br(),
				#info and switch mds metadata
				html.Div([
					#info mds metadata
					html.Div([
			...
			html.Div(id="mds_metadata_div", children=[
				dcc.Loading(
					...
					children = dcc.Graph(id="mds_metadata", style={"height": 535}),
					type = "dot",
					color = "#33A02C"
				)
			...
			html.Div(id="mds_expression_div", children=[
				dcc.Loading(
					...
					children = dcc.Graph(id="mds_expression", style={"height": 535}),
					type = "dot",
					color = "#33A02C"
				)
			...
			html.Div([
				...
				html.Div([
					...
					html.Div([
						...
						#search bar
						html.Div([
							dbc.Input(id="go_plot_filter_input", type="search", placeholder="Type here to filter GO gene sets", size="30", debounce=True),
				...
				dcc.Tabs(id="expression_abundance_profiling_tabs", value="heatmap", children=[
					...
					dcc.Tab(label="Boxplots", value="boxplots", children=[
						...
						html.Div(id="multiboxplot_div", children=[
							...
							], style={"height": 800, "width": "75%", "display": "inline-block", "vertical-align": "top"})
						], style={"width": "100%", "display": "inline-block"})
					], style=tab_style, selected_style=tab_selected_style),
				], style= {"height": 40})
			], style=tab_style, selected_style=tab_selected_style),
