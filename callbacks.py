...
def define_callbacks(app):
	...
	def plot_mds(mds_dataset, metadata, expression_dataset, gene_species, zoom_metadata, zoom_expression, show_legend_switch, update_plots, mds_metadata_fig, mds_expression_fig, legend_fig):
		...
		def get_displayed_samples(figure_data, print_stuff):
		...
		n_samples_mds_metadata = get_displayed_samples(mds_metadata_fig, print_stuff = True)
		n_samples_mds_expression = get_displayed_samples(mds_expression_fig, print_stuff = False)
		...
		if expression_dataset in ["human", "mouse"]:
			...
			expression_or_abundance = " abundance"
		if expression_dataset in ["human", "mouse"]:
			transcriptome_title = expression_dataset
		elif "archaea" in expression_dataset:
			transcriptome_title = "archaeal " + expression_dataset.split("_")[1]
		elif "bacteria" in expression_dataset:
			transcriptome_title = "bacterial " + expression_dataset.split("_")[1]
		elif "eukaryota" in expression_dataset:
			transcriptome_title = "eukaryota " + expression_dataset.split("_")[1]
		elif "viruses" in expression_dataset:
			transcriptome_title = "viral " + expression_dataset.split("_")[1]
